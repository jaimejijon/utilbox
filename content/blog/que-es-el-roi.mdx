...
**En bienes raíces:** compra de inmueble para renta. Si un departamento cuesta $1,000,000 pesos —si lo financias con hipoteca, el [Simulador de préstamo](/simulador-prestamo) te muestra la cuota mensual exacta— y genera $7,500 mensuales en renta ($90,000 al año) con gastos de $12,000, el ROI bruto anual es ($90,000 − $12,000) / $1,000,000 × 100 = **7.8%**.
...
El ROI tiene puntos ciegos importantes. No distingue entre una inversión que rindió 40% en dos meses y otra que rindió 40% en tres años: el tiempo vale. Para comparar inversiones con distintos horizontes, combina el ROI con la tasa interna de retorno (TIR) o el ROI anualizado. Para inversiones a largo plazo, la [Calculadora de interés compuesto](/calculadora-interes-compuesto) te muestra cómo crece el capital mes a mes.
