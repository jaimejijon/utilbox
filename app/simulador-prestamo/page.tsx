      ...
      <main className="flex-1 w-full" style={{ maxWidth: "1024px", margin: "0 auto", padding: "32px 24px 48px" }}>
            ...
            {resultado ? (
              <div className="flex flex-col gap-4">
                ...
                <div style={{ background: "#141520", border: "0.5px solid #1E2030", borderRadius: "10px", padding: "16px" }}>
                  <p style={{ fontSize: "12px", fontWeight: 600, color: "#888", marginBottom: "10px" }}>Composición del costo total</p>
                        ...
                        <tbody>
                          {resultado.tabla.map((row) => (
                            <tr key={row.mes} style={{ borderBottom: "0.5px solid #1A1A2A" }}>
                              <td style={{ padding: "8px 12px", color: "#888" }}>{row.mes}</td>
        ...
        <div className="mt-14 space-y-8">
          ...
          <div style={{ background: "#141520", border: "0.5px solid #1E2030", borderRadius: "10px", padding: "20px 24px" }}>
            <h3 style={{ fontSize: "16px", fontWeight: 600, color: "#ECECEC", marginBottom: "12px" }}>Ejemplo práctico: el costo de alargar el plazo</h3>
            <p style={{ fontSize: "13px", color: "#888", lineHeight: "1.65", marginBottom: "14px" }}>
              Un préstamo de <strong style={{ color: "#D0D0D0" }}>$80,000 MXN</strong> al <strong style={{ color: "#D0D0D0" }}>18% anual</strong> cambia drásticamente según el plazo que elijas:
            </p>
                ...
                <thead>
                  <tr style={{ background: "#0F1117" }}>
                    {["Plazo", "Cuota mensual", "Total pagado", "Total intereses"].map((h, i) => (
                      <th key={h} style={{ padding: "10px 12px", textAlign: i === 0 ? "left" : "right", fontWeight: 600, color: i === 3 ? "#E07070" : "#888", borderBottom: "0.5px solid #1E2030" }}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
