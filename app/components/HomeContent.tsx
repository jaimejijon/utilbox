...
const badgeColors = ["#5C6BC0", "#6EC9A0", "#74AEDD"];
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-14 text-center">
        ...
        >
          {t.hero.title1}
          <br />
          <em style={{ fontStyle: "normal", color: "#5C6BC0" }}>{t.hero.title2}</em>
        </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {categoryCards.map((cat) => (
              ...
              >
                ...
                >
                  {cat.count} {t.home.toolsCountSuffix}
                </p>
                <span
                  style={{
                    fontSize: "12px",
              ...
              {t.badges.map((badge, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "11px", color: "#F5F5F5" }}>{badge.sub}</p>
                  </div>
                </div>
              ))}
            </div>
